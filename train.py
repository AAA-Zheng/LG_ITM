...
def main():
    ...
    parser.add_argument('--loss', default='lg',
                        help='contrastive | lg')
    ...
    parser.add_argument('--language_model', default='mpnet',
                        help='clip | mpnet | glove')
    parser.add_argument('--percent', default=70,
                        help='percent.')
    ...
    parser.add_argument('--val_step', default=50000000, type=int,
    ...
    for epoch in range(start_epoch, opt.num_epochs):
        ...
        print('model path:', opt.model_name)
